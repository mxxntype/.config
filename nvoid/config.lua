...
nvoid.keys.normal_mode["<leader>w"] = ":w<cr>"
nvoid.keys.normal_mode["<Tab>"] = ":BufferLineCycleNext<CR>"
nvoid.keys.normal_mode["<S-Tab>"] = ":BufferLineCyclePrev<CR>"

nvoid.keys.insert_mode["<C-h>"] = "<left>"
nvoid.keys.insert_mode["<C-j>"] = "<down>"
nvoid.keys.insert_mode["<C-k>"] = "<up>"
nvoid.keys.insert_mode["<C-l>"] = "<right>"
